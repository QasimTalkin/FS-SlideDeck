            ...
            <div className="max-w-6xl w-full mx-auto relative z-10 text-center flex flex-col items-center">
                ...
                <h1 className="text-6xl md:text-8xl lg:text-9xl leading-[0.9] font-sans font-black tracking-tighter mb-12 text-textMain">
                    <div className="overflow-hidden">
                        <span ref={addToRefs} className="block hover:text-primary transition-colors duration-700 cursor-default">Precision_Web.</span>
                    </div>
                    <div className="overflow-hidden">
                        <span ref={addToRefs} className="block text-primary/40 hover:text-primary transition-colors duration-700 cursor-default">Surgical_Logic.</span>
                    </div>
                </h1>
                ...
                <div className="overflow-hidden max-w-3xl mx-auto glass-clinic p-12 rounded-[2.5rem] border-white/5 relative group mb-16">
                    ...
                    <p ref={addToRefs} className="text-xl md:text-2xl leading-relaxed font-sans font-light text-textMain/80">
                        Welcome to the clinic. We dissect complex frameworks into digestible, high-signal patterns. No friction. No overhead. <span className="text-primary font-mono font-bold">Access_Granted.</span>
                    </p>
                </div>
                ...
                <div className="overflow-hidden">
                    <div ref={addToRefs} className="flex flex-col sm:flex-row gap-8">
                        ...
                        <a href="#features" className="px-14 py-5 glass-clinic border border-white/10 rounded-full font-mono font-bold text-sm text-textMain/50 hover:text-primary hover:border-primary/40 transition-all uppercase tracking-[0.2em]">
                            View_Diagnostics
                        </a>
                    </div>
                </div>
