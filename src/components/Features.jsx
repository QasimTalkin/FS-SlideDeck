            ...
            <div className="max-w-6xl mx-auto">
                <div className="mb-20 text-center">
                    ...
                    <p className="text-textMuted max-w-2xl mx-auto text-lg">
                        Our curriculum is engineered for students who demand clarity. From HTML basics to advanced system architecture, we provide the tools to build industry-standard software.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div ref={addToRefs} className="clinic-card p-10 group bg-surface/40 backdrop-blur-sm">
                        <div className="absolute top-6 right-6 flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/10 border border-primary/20">
                            ...
                            <span className="font-mono text-[9px] text-primary font-bold uppercase tracking-tight">Access: FREE</span>
                        </div>
                        ...
                        <h3 className="text-2xl font-bold mb-4 text-white tracking-tight uppercase group-hover:text-primary transition-colors">Everything_Free</h3>
                        <p className="text-textMuted font-normal leading-relaxed text-sm">
                            No catch. No subscriptions. I've opened up my entire roadmap so you can start building right now.
                        </p>
                    </div>
                    ...
                    <div ref={addToRefs} className="clinic-card p-10 group bg-surface/40 backdrop-blur-sm">
                        <div className="absolute top-6 right-6 flex items-center gap-1.5 px-3 py-1 rounded-full bg-accent/10 border border-accent/20">
                            ...
                            <span className="font-mono text-[9px] text-accent font-bold uppercase tracking-tight">Style: VISUAL</span>
                        </div>
                        ...
                        <h3 className="text-2xl font-bold mb-4 text-white tracking-tight uppercase group-hover:text-accent transition-colors">Visual_Vibes</h3>
                        <p className="text-textMuted font-normal leading-relaxed text-sm">
                            I love diagrams. I've built visual guides for every concept so you can see exactly how the data flows.
                        </p>
                    </div>
                    ...
                    <div ref={addToRefs} className="clinic-card p-10 group bg-surface/40 backdrop-blur-sm">
                        <div className="absolute top-6 right-6 flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/10 border border-primary/20">
                            <span className="w-1.5 h-1.5 bg-primary rounded-full animate-pulse"></span>
                            <span className="font-mono text-[9px] text-primary font-bold uppercase tracking-tight">Type: INDUSTRY</span>
                        </div>
                        <div className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center mb-8 text-primary shadow-[0_0_20px_rgba(0,245,255,0.1)] group-hover:scale-110 transition-transform duration-500">
                        ...
                        <h3 className="text-2xl font-bold mb-4 text-white tracking-tight uppercase group-hover:text-primary transition-colors">Pro_Skills</h3>
                        <p className="text-textMuted font-normal leading-relaxed text-sm">
                            I'll show you the real-world stuff. Learn the professional techniques that I actually use in industry every day.
                        </p>
                    </div>
                    ...
                    <div ref={addToRefs} className="clinic-card p-10 group bg-surface/40 backdrop-blur-sm">
                        <div className="absolute top-6 right-6 flex items-center gap-1.5 px-3 py-1 rounded-full bg-accent/10 border border-accent/20">
                            <span className="w-1.5 h-1.5 bg-accent rounded-full animate-pulse"></span>
                            <span className="font-mono text-[9px] text-accent font-bold uppercase tracking-tight">Mode: PRACTICAL</span>
                        </div>
                        <div className="w-16 h-16 rounded-2xl bg-accent/10 flex items-center justify-center mb-8 text-accent shadow-[0_0_20px_rgba(255,0,229,0.1)] group-hover:scale-110 transition-transform duration-500">
                        ...
                        <p className="text-textMuted font-normal leading-relaxed text-sm">
                            Let's build something cool together. Every module is based on a real project you can show off to employers.
                        </p>
                    </div>
